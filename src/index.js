...
async function main() {
  ...
  try {
    ...
    console.error(`Unsupported sport: "${sportName}". Available adapters: nba, mlb, nfl, nhl, mls, epl, laliga, bundesliga, seriea, ligue1, primeiraliga, eredivisie, wnba, ligamx, brasileirao, nwsl, saudipro, j1, gleague`);
    process.exit(1);
  }
  ...
  const SPORT_EMOJI = { mlb: "⚾", nfl: "🏈", nhl: "🏒", mls: "⚽", epl: "⚽", laliga: "⚽", bundesliga: "⚽", seriea: "⚽", ligue1: "⚽", primeiraliga: "⚽", eredivisie: "⚽", wnba: "🏀", ligamx: "⚽", brasileirao: "⚽", nwsl: "⚽", saudipro: "⚽", j1: "⚽", gleague: "🏀" };
