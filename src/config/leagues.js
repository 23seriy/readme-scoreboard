...
const LEAGUES = [
  ...
  league({ key: "ucl", name: "UEFA Champions League", category: "Soccer", endpoint: "soccer/uefa.champions", renderer: "soccer", emoji: "⚽", light: `${ESPN_CDN}/i/leaguelogos/soccer/500/2.png`, dark: `${ESPN_CDN}/i/leaguelogos/soccer/500-dark/2.png`, start: [7, 1], end: [6, 30], nextLabel: "July", fallback: ["2026-07-07", "2027-07-01"] }),
  league({ key: "uel", name: "UEFA Europa League", category: "Soccer", endpoint: "soccer/uefa.europa", renderer: "soccer", emoji: "⚽", light: `${ESPN_CDN}/i/leaguelogos/soccer/500/2310.png`, dark: `${ESPN_CDN}/i/leaguelogos/soccer/500-dark/2310.png`, start: [7, 1], end: [6, 30], nextLabel: "July", fallback: ["2026-07-09", "2027-07-01"] }),
